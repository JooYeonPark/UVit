...
public class Setting_AlarmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.alarm_tabs);
...
//        tabLayout.setTabMode(TabLayout.MODE_FIXED);
        ...
        final ViewPager viewPager = (ViewPager) findViewById(R.id.alarm_container);
    ...
    private class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        public PagerAdapter(FragmentManager fm) {
            super(fm);
            list.add(new FragmentSetting_Alarm());
        }
